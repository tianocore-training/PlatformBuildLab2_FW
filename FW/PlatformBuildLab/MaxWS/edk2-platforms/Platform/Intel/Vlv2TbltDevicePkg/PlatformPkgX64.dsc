...
[Defines]
  ...
  !ifdef $(USE_NEW_ROOT)
    POSTBUILD                           = python Vlv2TbltDevicePkg/Feature/Capsule/GenerateCapsule/GenCapsuleAll_New_Root.py
  !else
    POSTBUILD                           = python Vlv2TbltDevicePkg/Feature/Capsule/GenerateCapsule/GenCapsuleAll_EDKII_TEST.py
  !endif
